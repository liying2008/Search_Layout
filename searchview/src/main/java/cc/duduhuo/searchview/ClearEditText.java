...
public class ClearEditText extends AppCompatEditText {
    ...
    private void init() {
        ...
        mClearDrawable = ResourcesCompat.getDrawable(resources, R.drawable.ic_clear, null);
        mSearchDrawable = ResourcesCompat.getDrawable(resources, R.drawable.ic_search, null);
