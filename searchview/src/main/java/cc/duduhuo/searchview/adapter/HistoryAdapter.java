package cc.duduhuo.searchview.adapter;
...
import cc.duduhuo.searchview.DrawableCenterTextView;
import cc.duduhuo.searchview.R;
...
public class HistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        if (getItemViewType(position) == TYPE_ITEM) {
            ...
            itemViewHolder.mLlItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        mListener.onItemClick(holder.getBindingAdapterPosition(), history);
                    }
                }
            });
            itemViewHolder.mIbDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        mListener.onDelete(holder.getBindingAdapterPosition(), history);
                    }
                }
            });
        } else {
    ...
    public class FooterViewHolder extends RecyclerView.ViewHolder {
        ...
        public FooterViewHolder(@NonNull View itemView) {
            ...
            if (mClearHistoryTextColor != null) {
            ...
            if (mClearHistoryTextBackground != TypedValue.TYPE_NULL) {
